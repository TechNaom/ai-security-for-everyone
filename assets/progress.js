/*
  Client-side progress tracker for AI Security for Everyone.
...
window.AISFEProgress = (function () {
  const STORAGE_KEY = "aisfe-progress-v1";
...
document.addEventListener("DOMContentLoaded", function () {
  if (window.AISFEProgress) window.AISFEProgress.renderBadges();
});
