...
# TODO 1: fill in the moment key (e.g. "result_arrival") for each scenario.
exercise_1_answers = {
    "lab_api_mixed_fields": "",  # TODO
    "tool_role_not_enough": "",  # TODO
    "model_proposes_reschedule": "",  # TODO
    "raw_concatenation_tool_and_system": "",  # TODO
    "unscoped_credential": "",  # TODO -- careful, this is about the credential's own scope, not the message content
    "no_confirmation_before_execute": "",  # TODO
}
...
exercise_4_answers = {
    "planted_note_no_directive_phrasing": "",  # TODO
    "no_field_trust_recorded": "",  # TODO
    "credential_reaches_further_than_tool": "",  # TODO
    "reschedule_authorized_by_tool_content_alone": "",  # TODO
}
...
# ---------------------------------------------------------------------------
# TODO 5: fill in the DEFENSES key for each moment.
exercise_5_answers = {
    "result_arrival": "",  # TODO
    "context_assembly": "",  # TODO
}
...
exercise_7_answers = {
    "excessive_agency_category": "",  # TODO
    "tool_misuse_and_privilege_categories": "",  # TODO
    "twenty_four_percent_finding": "",  # TODO
    "forty_eight_percent_finding": "",  # TODO
}
