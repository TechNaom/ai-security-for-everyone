...
Build a real, self-contained model-extraction defense tool: a scorer that
...
def score_volume_vs_baseline(queries, historical_daily_baseline, window_days):
    ...
    #   score = (ratio - 1) / (5 - 1) * 100, clamped to [0, 100]
...
def score_category_coverage_breadth(queries, all_categories):
    ...
    """
    # TODO:
    #   if not all_categories: return 0.0
...
def classify_risk(composite_score, total_queries, min_queries_for_signal=20):
    ...
    """
    # TODO:
    #   if total_queries < min_queries_for_signal: return "insufficient-data"
    #   if composite_score >= 70: return "high"
    #   if composite_score >= 40: return "watch"
    #   return "normal"
